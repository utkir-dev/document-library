...
@HiltViewModel
class BlockedDevicesViewModelImpl @Inject constructor(
    ...
    override fun observeDevices() {
        viewModelScope.launch(Dispatchers.IO) {
            repository.getBlockedDevices().collectLatest {
    ...
    override fun searchDevice(seachText: String) {
        viewModelScope.launch(Dispatchers.IO) {
            repository.getSearchedBlockedDevices(seachText).collectLatest {
                devices.postValue(it)
            }
        }
    }
